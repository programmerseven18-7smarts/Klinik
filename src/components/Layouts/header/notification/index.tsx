...
export function Notification() {
  ...
  return (
    ...
    >
      <DropdownTrigger
        className="grid size-10 shrink-0 place-items-center rounded-full border bg-gray-2 text-dark outline-none hover:text-primary focus-visible:border-primary focus-visible:text-primary dark:border-dark-4 dark:bg-dark-3 dark:text-white dark:focus-visible:border-primary sm:size-12"
